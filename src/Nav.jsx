        ...
        <nav className="navbar navbar-expand-lg container-fluid">
            <div className="container-fluid">
                ...
                <div className="navbar-nav ">
                        ...
                        <a className="nav-link active mx-2 px-3 my-1" aria-current="page" href="#about">About</a>
                        <a className="nav-link active mx-2 px-3 my-1" aria-current="page" href="#schedule">Schedule</a>
                        
                        

                       <button className="button mx-2 px-3 my-1">
